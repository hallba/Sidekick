...
parser = SidekickOptParse.Multi_Helix_Options(("-j",))
...
angle_ranges = [i%7*15 for i in range(number_of_repeats)]
position_ranges = [(i%7*1.5)-4.5 for i in range(number_of_repeats)]
shuffle(angle_ranges)
shuffle(position_ranges)
seed_angle_combos = zip(seed_packet,angle_ranges,position_ranges)
