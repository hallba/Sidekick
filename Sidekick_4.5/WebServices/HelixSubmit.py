...
def grab_data():
    ...
    form =  FieldStorage()
    print "<p><b>Input values:</b>"
    print "<table class='datasheet'>"
    print "<tr class='even'><th>Input</th><th>Value</th></tr>"
    rowtype = "odd"
    for item in details.keys():
    	details[item] = form.getvalue(item)
    	print "<tr class=" + rowtype + ">","<td>",item,"</td>","<td>", details[item],"</td>","</tr>"
    	if rowtype == "even":
    		rowtype = "odd"
    	else:
    		rowtype = "even"
...
if __name__ == "__main__":
	...
	print """<link rel="stylesheet" type="text/css"
	          href="../Sidekick.css"
	          title="standard" >"""
	print """<link rel="apple-touch-icon-precomposed" href="images/sidekick.png"/>"""
	print """</head>"""
	print """<h1>Checking your submitted data... </h1><p>"""


	input_options = grab_data()
	generate_plist(input_options)
	#print_confirmation(input_options)
	print "</p><p>Your job results will appear at</p>"
