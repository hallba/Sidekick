...
#fix gromacs issue
#os.system("touch residuetypes.dat")
...
GromacsInterface.SDMinimise(topology_file="ioned_topol",input_structure="ioned.pdb",output_name="em",maxwarn=1)
...
try:
	GromacsInterface.RobustMolecularDynamics(topology_file="ioned_topol",input_structure="em",output_name="t_0",seed=seed,steps=MDsteps,pcoupling=pcoupling,wallclock=options.wallclock,epsilon=System.epsilon,temperature=options.temperature,apolar=System.apolar,pme=System.pme)
except:
	if options.batch:
		sys.exit()
